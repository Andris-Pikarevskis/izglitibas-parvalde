...
<body>
        ...
        <p><input type="text" name="" placeholder="iestādes nosaukums" class="iestades-nosaukums" value=""> saskaņā ar</p>
        ...
        <input type="text" name="" placeholder="(norādīt izmantoto izvērtēšanas metodi; ja izmantotas atšķirīgas metodes, norādīt visas atbilstoši to izmantošanai)" class="iestades-nosaukums" value=""></p>
        <p><br /> Izvērtējumu apliecinošs dokuments: 
        <input type="text" name="" placeholder="(pievienot hipersaiti uz izvērtējumu apliecinošu dokumentu, protokolu, pārskatu vai citu līdzvērtīgu dokumentu)" class="iestades-nosaukums" value=""></p>
        <br><br><h2>Atbilstības statuss</h2>
        <p><em>Atzīmēt vajadzīgo - vienu no Šādiem veidiem</em>:</p>
        <p>Tīmekļvietne</p><br><p><input type="checkbox" id="" name="" value=""><strong> pilnīgi atbilst </strong>noteikumiem Nr: 445</p>
        <p><div class="iestades-nosaukums1 pre-wrap"></div></p>

        <p><br /> Tīmekļvietne</p><p><strong><input type="checkbox" id="" name="" value=""> daļēji atbilst </strong>noteikumiem Nr: 445 šādu neatbilstību/atbrīvojumu dēļ:</p>
        <p><input type="text" name="" placeholder="(var norādīt vairākas tīmekļvietnes un/vai mobilās lietotnes)" class="iestades-nosaukums1" value=""></p>
        <p><textarea rows="15" placeholder="(norādīt neatbilstošo saturu vai pamatot atbrīvojumu, norādot attiecīgos minēto noteikumu punktus)" class="iestades-nosaukums1"></textarea></p>
        <p><div class="iestades-nosaukums1 pre-wrap"></div></p>

        <p><br />Tīmekļvietne</p><p><strong><input type="checkbox" name="" value=""> neatbilst </strong>noteikumiem Nr: 445 šādu neatbilstību/atbrīvojumu dēļ:</p>
        <p> <input type="text" name="" placeholder="(var norādīt vairākas tīmekļvietnes)" class="iestades-nosaukums1" value=""></p>
        <p><div class="iestades-nosaukums1 pre-wrap"></div></p>
        ...
        <p><strong><input type="checkbox" name="" value="">Neatbilstība prasībām</strong>, kas minētas noteikumos Nr. 445</p>
        <p> <input type="text" name="" class="iestades-nosaukums1" value=""></p>
        <p><div class="iestades-nosaukums1 pre-wrap"></div></p><br>

        <p><input type="checkbox" name="" value=""; ?>Noteikumos Nr. 445 minēto <strong>piekļūstamības prasību nodrošināšana rada nesamērīgu slogu</strong></p>
        <p> <input type="text" name="" class="iestades-nosaukums1" value=""></p>
        <p><div class="iestades-nosaukums1 pre-wrap"></div></p><br>
        
        <p><strong><input type="checkbox" name="" value="">Neattiecas. </strong>Uz saturu neattiecas noteikumu Nr. 445 prasības</p>
        <p> <input type="text" name="" class="iestades-nosaukums1" value=""></p>
        <p><div class="iestades-nosaukums1 pre-wrap"></div></p><br>
        ...
        <input type="text" name="" placeholder="(norādīt pirmreizējā paziņojuma sagatavošanas datumu)" class="iestades-nosaukums" value=""></p>
        <br><br>
        
        <p>Atkārtoti pārskatīts: 
                <input type="text" name="" placeholder="(norādīt paziņojuma pēdējās pārskatīšanas datumu; nenorāda, ja šis ir pirmreizējais paziņojums)" class="iestades-nosaukums" value="">
        </p>
